<form wire:submit.prevent="save">
    <div class="sm:text-left sm:mx-[20rem]  max-w-screen-xl mx-auto pt-[8px] pb-[5rem]">
        <div class="border-[#050419] w-[1127px] h-[586px] text-[24px] font-sans p-4 text-white rounded-lg bg-transparent dark:bg-transparent outline-none">
            ...
            <div class="pt-10">
                <button type="submit"
                    class="text-black font-semibold border-[#050419] w-[347px] h-[46px] bg-[#21E8E6] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-sm px-4 py-[14px]  text-center inline-block">Add
                </button>
            </div>
        </div>
    </div>
